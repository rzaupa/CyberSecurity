...
#Rule5. Divide the block into 2 6bit sections Lr,Rr
#Rule6. Using Rr, "expand" the value from 6bits to 8bits.
#    Do this by remapping the values using their index, e.g.
#    1 2 3 4 5 6 -> 1 2 4 3 4 3 5 6
#Rule7. XOR the result of this with 8bits of the Key beginning with Key[iR+r]
#   and wrapping back to the beginning if necessary.
#Rule8. Divide the result into 2 4bit sections S1, S2
#Rule9. Calculate the 2 3bit values using the two "S boxes" below, using S1 and S2 as input respectively.
    #
	# S1	0	1	2	3	4	5	6	7
